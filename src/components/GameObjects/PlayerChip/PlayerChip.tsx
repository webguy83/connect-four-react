export default function PlayerChip() {
  return (
    <svg width='70px' height='75px' viewBox='0 0 70 75' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink'>
      ...
      <defs>
        <circle id='path-1-chip' cx='35' cy='35' r='32'></circle>
        <filter x='-3.9%' y='-3.9%' width='107.8%' height='107.8%' filterUnits='objectBoundingBox' id='filter-chip'>
      ...
      <g id='Designs' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='counter-red-large'>
          ...
          <g id='Oval-Copy-43'>
            <use fill='#FD6687' fillRule='evenodd' xlinkHref='#path-1-chip'></use>
            <use fill='black' fillOpacity='1' filter='url(#filter-chip)' xlinkHref='#path-1-chip'></use>
          </g>
        </g>
      </g>
    </svg>
