  ...
  return (
    <Box component='svg' ref={ref} className='piece' width='70px' height='75px' viewBox='0 0 70 75' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink'>
      ...
      <defs>
        ...
        <filter x='-3.9%' y='-3.9%' width='107.8%' height='107.8%' filterUnits='objectBoundingBox' id='filter-2-piece'>
      ...
      <g id='Designs' stroke='none' strokeWidth='1' fill='none' fillRule='evenodd'>
        <g id='counter-red-large'>
          ...
          <g id='Oval-Copy-43'>
            <use fill='#FD6687' fillRule='evenodd' xlinkHref='#path-1-piece'></use>
            <use fill='black' fillOpacity='1' filter='url(#filter-2-piece)' xlinkHref='#path-1-piece'></use>
          </g>
        </g>
      </g>
    </Box>
